...
function logger($message, $email) {

    $log = new \Monolog\Logger('logger');
    $log->pushHandler(new \Monolog\Handler\StreamHandler('../storage/log.log', \Monolog\Logger::DEBUG));
    ...
    switch($message) {
        ...
        case 1:
            ...
            break;
        case 2:
            $log->warning("failed login     ($email)\n");
            break;
        case 3:
            $log->info("   main page access ($email)\n");
            break;
    }
